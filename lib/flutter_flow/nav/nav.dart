...
class AppStateNotifier extends ChangeNotifier {
  TheETonFirebaseUser? initialUser;
  TheETonFirebaseUser? user;
  ...
  void update(TheETonFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'plandetails',
              asyncParams: {
                'plans': getDoc('Plans', PlansRecord.serializer),
              },
              builder: (context, params) => PlandetailsWidget(
                plans: params.getParam('plans', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'paymentInfo',
            ...
            FFRoute(
              ...
              path: 'gcash',
              asyncParams: {
                'amount': getDoc('Plans', PlansRecord.serializer),
              },
              builder: (context, params) => GcashWidget(
                amount: params.getParam('amount', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'chatMain',
            ...
            FFRoute(
              ...
              path: 'planslist',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'planslist')
                  : PlanslistWidget(),
            ),
            FFRoute(
              name: 'joinwebinar',
              path: 'joinwebinar',
              builder: (context, params) => JoinwebinarWidget(),
            )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/08f6ab55f4fee638c809481861e9993e.jpg',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
