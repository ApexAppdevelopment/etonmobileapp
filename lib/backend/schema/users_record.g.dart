    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'isHost':
          ...
          break;
        case 'job_tile':
          result.jobTile = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String? _jobTile;
  String? get jobTile => _$this._jobTile;
  set jobTile(String? jobTile) => _$this._jobTile = jobTile;
